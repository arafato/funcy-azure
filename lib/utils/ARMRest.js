...
function listFunctions(sub, rg, functionapp, token) {
    let adress = `https://management.azure.com/subscriptions/${sub}/resourceGroups/${rg}/providers/Microsoft.Web/sites/${functionapp}/functions?api-version=2015-08-01`;
    let options = {
        method: 'GET',
        uri: adress,
