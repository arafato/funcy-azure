...
class ProjectCreateHandler {
	...
	process(options) {
		return BbPromise.try(() => {
			...
			let tenantId = options.t || options.tenantId;
			let apppId = options.a || options.appId;
			let password = options.p || options.password;
			let subscriptionId = options.s || options.subscriptionId;
